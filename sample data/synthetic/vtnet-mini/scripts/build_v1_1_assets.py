...
NEW_DM_CASES = [
    ...
    ("H052", "hard", "Liệt kê các chỉ số KQI mà value tại ts lớn nhất là số âm (không hợp lệ) trong kqi_monitor_web.",
     "Tại lần đo gần nhất, những chỉ số KQI web nào đang báo giá trị không hợp lệ?",
